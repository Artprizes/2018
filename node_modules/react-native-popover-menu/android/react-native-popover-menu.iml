...
<module external.linked.project.id=":react-native-popover-menu" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android/app" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.android.support:recyclerview-v7-25.0.0" level="project" />
